        ...
        <main className="grid grid-cols-1 gap-4">
          ...
          {tasks.length === 0 && (
            <div className="flex flex-col items-center justify-center p-20 text-center border-2 border-dashed border-midnight-border rounded-default bg-midnight-card/30">
              <p className="text-[1.2rem] text-midnight-text-secondary mb-2">생성된 프로젝트가 없습니다.</p>
              <p className="text-[1rem] text-midnight-text-secondary/60">'새 프로젝트 추가' 버튼을 눌러 시작하세요.</p>
            </div>
          )}
        </main>
      </div>
